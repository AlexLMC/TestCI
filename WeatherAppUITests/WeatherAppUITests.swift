...
class WeatherAppUITests: XCTestCase {
    ...
    func testExample() {
        ...
        app.otherElements.containing(.image, identifier:"background-blur").children(matching: .other).element.children(matching: .searchField).element.tap()
       ...
       sleep(4)
        XCUIApplication().staticTexts["В городе Moscow"].tap()
